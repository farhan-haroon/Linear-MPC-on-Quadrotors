...
struct B_my_sim_T {
  ...
  real_T u[4];                         // '<S24>/optimizer'
  real_T y_innov[4];
  real_T old_u[4];
  real_T TmpSignalConversionAtSFunct[4];// '<S24>/optimizer'
  real_T xest[4];
  real_T x_ref;                        // '<Root>/Sine Wave'
  real_T y_ref;                        // '<Root>/Constant1'
  real_T z_ref;                        // '<Root>/Constant2'
  real_T yaw_ref;                      // '<Root>/Constant3'
  real_T umin_scale1[4];               // '<S4>/umin_scale1'
  real_T xk1[4];                       // '<S24>/optimizer'
  real_T old_u_m;
  real_T old_u_c;
  real_T old_u_k;
  real_T old_u_cx;
  ...
  boolean_T iAout[48];                 // '<S24>/optimizer'
  int32_T i;
  int32_T rseq_tmp;
  int32_T nA;
  int32_T tmp;
...
struct DW_my_sim_T {
  ...
  real_T last_mv_DSTATE[4];            // '<S4>/last_mv'
  real_T last_x_PreviousInput[4];      // '<S4>/last_x'
  struct {
    void *LoggedData[4];
  ...
  uint8_T is_active_c3_mpclib;         // '<S24>/optimizer'
  boolean_T Memory_PreviousInput[48];  // '<S4>/Memory'
};
...
//
//  '<Root>' : 'my_sim'
//  '<S1>'   : 'my_sim/Blank Message1'
//  '<S2>'   : 'my_sim/MPC Controller'
//  '<S3>'   : 'my_sim/Velocity publisher'
//  '<S4>'   : 'my_sim/MPC Controller/MPC'
//  '<S5>'   : 'my_sim/MPC Controller/MPC/MPC Matrix Signal Check'
//  '<S6>'   : 'my_sim/MPC Controller/MPC/MPC Matrix Signal Check1'
//  '<S7>'   : 'my_sim/MPC Controller/MPC/MPC Matrix Signal Check2'
//  '<S8>'   : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check'
//  '<S9>'   : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check1'
//  '<S10>'  : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check2'
//  '<S11>'  : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check3'
//  '<S12>'  : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check4'
//  '<S13>'  : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check5'
//  '<S14>'  : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check6'
//  '<S15>'  : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check7'
//  '<S16>'  : 'my_sim/MPC Controller/MPC/MPC Preview Signal Check8'
//  '<S17>'  : 'my_sim/MPC Controller/MPC/MPC Scalar Signal Check'
//  '<S18>'  : 'my_sim/MPC Controller/MPC/MPC Scalar Signal Check1'
//  '<S19>'  : 'my_sim/MPC Controller/MPC/MPC Scalar Signal Check2'
//  '<S20>'  : 'my_sim/MPC Controller/MPC/MPC Vector Signal Check'
//  '<S21>'  : 'my_sim/MPC Controller/MPC/MPC Vector Signal Check1'
//  '<S22>'  : 'my_sim/MPC Controller/MPC/MPC Vector Signal Check6'
//  '<S23>'  : 'my_sim/MPC Controller/MPC/moorx'
//  '<S24>'  : 'my_sim/MPC Controller/MPC/optimizer'
//  '<S25>'  : 'my_sim/MPC Controller/MPC/optimizer/optimizer'
