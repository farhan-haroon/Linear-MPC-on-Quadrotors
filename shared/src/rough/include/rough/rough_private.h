...
//
#ifndef RTW_HEADER_rough_private_h_
#define RTW_HEADER_rough_private_h_
#include "rtwtypes.h"
...
extern void rough_derivatives(void);

#endif                                 // RTW_HEADER_rough_private_h_
