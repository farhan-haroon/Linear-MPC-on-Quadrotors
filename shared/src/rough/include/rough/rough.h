...
//
#ifndef RTW_HEADER_rough_h_
#define RTW_HEADER_rough_h_
#include "rtwtypes.h"
...
struct B_rough_T {
  ...
  real_T dv[48];
  real_T cTol[48];
  SL_Bus_rough_mavros_msgs_PositionTarget BusAssignment1;// '<S1>/Bus Assignment1' 
  real_T Opt[26];
  real_T Rhs[26];
  int32_T iC[48];
  real_T zopt[13];
...
struct P_rough_T_ {
  ...
  SL_Bus_rough_mavros_msgs_PositionTarget Constant_Value;// Computed Parameter: Constant_Value
...
struct tag_RTM_rough_T {
  const char_T *errorStatus;
  RTWExtModeInfo *extModeInfo;
  RTWSolverInfo solverInfo;
  X_rough_T *contStates;
  int_T *periodicContStateIndices;
  real_T *periodicContStateRanges;
  real_T *derivs;
  XDis_rough_T *contStateDisabled;
...
extern "C"
{
  ...
  extern struct B_rough_T rough_B;
...
// Continuous states (default storage)
extern X_rough_T rough_X;

// Disabled states (default storage)
extern XDis_rough_T rough_XDis;

// Block states (default storage)
extern struct DW_rough_T rough_DW;
...
extern "C"
{
  ...
  extern void rough_initialize(void);
  extern void rough_step(void);
  extern void rough_terminate(void);
...
extern "C"
{
  ...
  extern RT_MODEL_rough_T *const rough_M;
...
//
//  '<Root>' : 'rough'
//  '<S1>'   : 'rough/Command Velocity Publisher'
//  '<S2>'   : 'rough/MPC Controller'
//  '<S3>'   : 'rough/Command Velocity Publisher/Blank Message'
//  '<S4>'   : 'rough/Command Velocity Publisher/Publish2'
//  '<S5>'   : 'rough/MPC Controller/MPC Controller'
//  '<S6>'   : 'rough/MPC Controller/Ramp'
//  '<S7>'   : 'rough/MPC Controller/MPC Controller/MPC'
//  '<S8>'   : 'rough/MPC Controller/MPC Controller/MPC/MPC Matrix Signal Check'
//  '<S9>'   : 'rough/MPC Controller/MPC Controller/MPC/MPC Matrix Signal Check1'
//  '<S10>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Matrix Signal Check2'
//  '<S11>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check'
//  '<S12>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check1'
//  '<S13>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check2'
//  '<S14>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check3'
//  '<S15>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check4'
//  '<S16>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check5'
//  '<S17>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check6'
//  '<S18>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check7'
//  '<S19>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Preview Signal Check8'
//  '<S20>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Scalar Signal Check'
//  '<S21>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Scalar Signal Check1'
//  '<S22>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Scalar Signal Check2'
//  '<S23>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Vector Signal Check'
//  '<S24>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Vector Signal Check1'
//  '<S25>'  : 'rough/MPC Controller/MPC Controller/MPC/MPC Vector Signal Check6'
//  '<S26>'  : 'rough/MPC Controller/MPC Controller/MPC/moorx'
//  '<S27>'  : 'rough/MPC Controller/MPC Controller/MPC/optimizer'
//  '<S28>'  : 'rough/MPC Controller/MPC Controller/MPC/optimizer/optimizer'

#endif                                 // RTW_HEADER_rough_h_
