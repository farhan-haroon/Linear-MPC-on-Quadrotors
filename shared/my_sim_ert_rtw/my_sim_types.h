...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_my_sim_geometry_msgs_Quaternion_
#define DEFINED_TYPEDEF_FOR_SL_Bus_my_sim_geometry_msgs_Quaternion_

// MsgType=geometry_msgs/Quaternion
struct SL_Bus_my_sim_geometry_msgs_Quaternion
{
  real_T X;
  real_T Y;
  real_T Z;
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_my_sim_geometry_msgs_Pose_
#define DEFINED_TYPEDEF_FOR_SL_Bus_my_sim_geometry_msgs_Pose_

// MsgType=geometry_msgs/Pose
struct SL_Bus_my_sim_geometry_msgs_Pose
{
  // MsgType=geometry_msgs/Point
  SL_Bus_my_sim_geometry_msgs_Point Position;

  // MsgType=geometry_msgs/Quaternion
  SL_Bus_my_sim_geometry_msgs_Quaternion Orientation;
};

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_my_sim_geometry_msgs_PoseStamped_
#define DEFINED_TYPEDEF_FOR_SL_Bus_my_sim_geometry_msgs_PoseStamped_

// MsgType=geometry_msgs/PoseStamped
struct SL_Bus_my_sim_geometry_msgs_PoseStamped
{
  // MsgType=std_msgs/Header
  SL_Bus_my_sim_std_msgs_Header Header;

  // MsgType=geometry_msgs/Pose
  SL_Bus_my_sim_geometry_msgs_Pose Pose;
};
